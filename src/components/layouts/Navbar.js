...
const Navbar = () => {
  ...
  return (
    <header className="text-white-100 sticky top-0 z-50 bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700 body-font">
        ...
        <div className="container lg:w-[80%] mx-auto flex flex-wrap p-3 flex-col md:flex-row items-center">
            ...
            <nav className='md:ml-auto flex flex-wrap items-center text-base justify-center'>
                <Link href="/cart" className='text-white mr-5 cursor-pointer hover:text-grey-200 flex items-center'>
                    Cart
                    <svg
