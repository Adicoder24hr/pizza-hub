  ...
  const handleCheckOut = async () =>{
    ...
    await fetch("api/ordersData", {
      ...
      if(Response.status === 200){
        ...
        setErrorMessage("if not logged in then, please login and try again!");
        setFail(true);
      }
    })
  };
  ...
  return (
   ...
   {success && (
    ...
    <div style={{ minHeight: "95vh" }} className='flex items-center overflow-x-hidden'>
      ...
      <div className='lg:w-[80%] w-[80%] md:w-[90%] overflow-hidden mx-auto flex border-gradient p-3 pb-10 m-10 rounded-lg flex-col'>
            ...
            <div className='overflow-hidden'>
              {
                state.length > 0 ?(
                  ...
                  <table class="min-w-full text-left text-lg font-light">
                    ...
                    <button onClick={handleCheckOut} className='border dark:border-gray-400 border-gray-900 rounded p-2 bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700 hover:text-gray-100'>Check Out</button>
                  </>
                       ) : 
