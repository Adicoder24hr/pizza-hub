...
const Admin = () => {
    ...
    const handleChange = (e) =>{
        ...
        if(e.target.name === "foodCategory"){
          if(e.target.value === "Pizza"){
            ...
            setFoodData((prevData)=>{
              return {...prevData, price: sidesPriceOptions};
            })
          }
        }
    };
  ...
  return (
    ...
    className='flex py-10 items-center justify-center'>
        <div className="container w-full max-w-md">
          ...
          <div className="mb-4">
            ...
            <div key={key} className='ml-4 mb-4'>
              <label htmlFor={key}
              className="block text-gray-700  dark:text-gray-300 text-sm font-bold mb-2">{key}</label>
              <input key={key} 
              type="number" 
              name={key} 
              className='shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 focus:border-indigo-700 text-gray-700 dark:text-gray-100  leading-tight focus:outline-none focus:shadow-outline'
              ...
              onChange={(e)=>{
                ...
                setFoodData({...foodData, price: {...foodData.price, [key]:e.target.value}})
          ...
          <div className='mb-4'>
                ...
                <div className='mb-4'>
                    ...
                    onChange={handleChange}
                    value={foodData.img}
                    placeholder="Enter your Food img"
                    className='shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 focus:border-indigo-700 text-gray-700 dark:text-gray-100  leading-tight focus:outline-none focus:shadow-outline'/>
                </div>
